...
public class MapperService extends AbstractIndexComponent implements Closeable {
    ...
    public MapperService(IndexSettings indexSettings, IndexAnalyzers indexAnalyzers,
        ...
        this.documentParser = new DocumentMapperParser(indexSettings, this, indexAnalyzers, similarityService,
                mapperRegistry, queryShardContextSupplier, xContentRegistry);
